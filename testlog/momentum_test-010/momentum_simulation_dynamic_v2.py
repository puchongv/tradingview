...
Version: 2.0 (Option C - Exponential Weighting)
Test: 010
Date: 2025-10-01
...
def calculate_momentum_score(pnls):
    """Option C: Exponential Weighting"""
...
if __name__ == "__main__":
    ...
    print("="*120)
    print("🚀 Test 010: Exponential Weighting (Option C) - Dynamic Strategy & Action")
    ...
    print(f"\n✅ Test 010 Complete!")
    print(f"Formula: Exponential (8,4,2,1,0.5)")
