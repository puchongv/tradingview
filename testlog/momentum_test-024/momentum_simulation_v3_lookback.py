#!/usr/bin/env python3
"""
Test: 024 - Acceleration (Option D) + 30-Day Lookback
Formula: 5×M₁ + 3×Acceleration
Period: 01 Oct 2025 (24 ชั่วโมง)
Actions: Buy/Sell ONLY (hard-code)
Lookback: ดึงข้อมูลย้อนหลัง 30 วัน เพื่อให้ P1-P6 มีค่าจริง
"""
import psycopg2
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    print("="*120)
    print("🚀 Test 024: Acceleration + 30-Day Lookback")
    print("📅 Simulation Period: 01 Oct 2025 (24 ชั่วโมง)")
    print(f"📊 Data Lookback: {LOOKBACK_DAYS} days (01 Sep - 01 Oct)")
    print(f"📊 Log Level: {LOG_LEVEL.upper()}")
    print("🎯 Actions: Buy/Sell ONLY (no FlowTrend)")
    print("="*120)
    results = run_simulation('2025-10-01 00:00:00', '2025-10-01 23:59:59', log_level=LOG_LEVEL, lookback_days=LOOKBACK_DAYS)
    print(f"\n✅ Test 024 Complete!")
