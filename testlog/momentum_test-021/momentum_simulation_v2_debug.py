...
if __name__ == "__main__":
    ...
    print("="*120)
    print("🚀 Test 021: Acceleration - Buy/Sell + DEBUG Mode (with Trade Details)")
    print("📅 Period: 22-30 Sep 2025 (8-9 วัน)")
    print(f"📊 Log Level: {LOG_LEVEL.upper()}")
    print("🎯 Actions: Buy/Sell ONLY (no FlowTrend)")
    print("="*120)
    results = run_simulation('2025-09-22 00:00:00', '2025-09-30 23:59:59', log_level=LOG_LEVEL)
    print(f"\n✅ Test 021 Complete!")
