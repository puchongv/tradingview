...
Recent Performance scoring system with DYNAMIC strategy selection.

Key Difference from v1.0:
- v1.0: Pre-selected fixed strategies
- v1.1: Scan ALL strategies, select TOP 6 by score every hour
...
if __name__ == "__main__":
    ...
    print("="*120)
    print("🚀 Starting Momentum-based Strategy Scoring Simulation (DYNAMIC TOP 6)")
