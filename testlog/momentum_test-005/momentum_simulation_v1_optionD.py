...
Version: 1.3 (Option D - Acceleration)
Date: 2025-10-01

Scoring Formula:
- M₁ = PNL₁ - PNL₂ (momentum ชั่วโมงล่าสุด)
- M₂ = PNL₂ - PNL₃
- Acceleration = M₁ - M₂ (momentum เพิ่มขึ้นหรือลดลง?)
...
def calculate_momentum_score(pnls):
    ...
    OPTION D: Acceleration (Momentum of Momentum)
    ...
    acceleration = m1 - m2  # Is momentum increasing or decreasing?
    
    # Score = momentum + acceleration bonus
...
if __name__ == "__main__":
    ...
    print("="*120)
    print("🚀 Starting Momentum-based Strategy Scoring Simulation (OPTION D: Acceleration)")
    print(f"📅 Period: {START_DATE} to {END_DATE}")
    print(f"💰 Investment: ${BET_SIZE}/trade, Payout: {PAYOUT}")
    print(f"🔍 Mode: Scan ALL strategies, select TOP {TOP_N} every hour")
    print(f"⚙️  Formula: 5×M₁ + 3×Acceleration")
    print("="*120)
