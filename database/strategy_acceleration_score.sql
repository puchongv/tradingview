-- ========================================================================================================
-- Strategy Acceleration Score
-- Formula: 5×M₁ + 3×Acceleration (M₁=P1-P2, Acceleration=M₁-M₂)
-- Description: Complete scoring system in single view
...
WITH 
-- Step 1: Get hourly trades with UTC+7 timezone
hourly_trades AS (
    SELECT 
        strategy,
        action,
...
-- Final: Clean output with UTC+7 timezone
SELECT 
...
'Strategy Acceleration Score - Complete scoring system
Formula: 5×M₁ + 3×Acceleration
