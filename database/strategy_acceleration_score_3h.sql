-- ========================================================================================================
-- Strategy Acceleration Score (3-Hour Version - Matched with Simulation)
-- Formula: 5×M₁ + 3×Acceleration (M₁ = P1 - P2, Acceleration = M₁ - M₂)
-- ✨ Uses only 3-hour lookback (same as Test 032/033 simulation)
-- ========================================================================================================
...
window_hours AS (
    -- ✨ เปลี่ยนจาก 5 hours เป็น 2 hours (3 ชั่วโมงรวม)
    SELECT generate_series(
               (SELECT end_hour FROM params) - INTERVAL '2 hours',
...
'Strategy Acceleration Score - 3-Hour Version (Matched with Simulation Test 032/033)
Formula: 5×M₁ + 3×Acceleration
Window: 3 hours (2 hours lookback + current hour)
